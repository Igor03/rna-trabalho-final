...
for i=1:realizacoes
    ...
    x_treino = dados(1:size(dados, 1)-97, :); % 120 amostras para treinamento
    x_testes = dados (size(dados, 1)-95:end, :); % 30 amostras para testes
...
title('Taxa de Acertos para "Dermatologia" (OLAM)');
xlabel('Realizações');
