...
for i=1:realizacoes
    ...
    x_treino = dados(1:size(dados, 1)-61, :); % 120 amostras para treinamento
    x_testes = dados (size(dados, 1)-59:end, :); % 30 amostras para testes
...
title('Taxa de Acertos para "Coluna" (OLAM)');
xlabel('Realizações');
