...
for i=1:qtd_realizacoes
    ...
    conj_treinamento = dados(1:size(dados, 1)-97, :); % 270 amostras para treinamento
    conj_testes = dados (size(dados, 1)-95:end, :); % 96 amostras para testes
    
    qtd_neur_ocultos = validacao(conj_treinamento, qtd_classes, qtd_atributos);
